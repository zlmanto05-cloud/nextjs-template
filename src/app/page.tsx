...
/* ─── Ancho de contenido consistente en TODA la página ─── */
const CONTAINER = "max-w-7xl mx-auto px-6 md:px-10";
...
export default function Home() {
  ...
  return (
    <main className="bg-white text-[#0d1526] antialiased overflow-x-hidden">
      ...
      {/* ════════════════════════════════
          ① HERO — altura reducida (68vh en vez de 92vh)
          Punto 2: título más pequeño que antes, mayor que subtítulo
          Punto 3: SIN highlight azul en el texto
          Punto 4: botón integrado DENTRO del hero (no barra separada)
      ════════════════════════════════ */}
      <section
        className="relative w-full flex flex-col justify-end overflow-hidden"
        style={{ minHeight: "68vh", paddingTop: 80 }}
        aria-label="Hero"
      >
        <div
          ...
          aria-hidden="true"
        />
        <div className="absolute inset-0 bg-gradient-to-r from-black/72 via-black/50 to-black/15" aria-hidden="true" />
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent" aria-hidden="true" />

        {/* Content — usa el mismo CONTAINER que el resto de la página */}
        <div className={`relative z-10 w-full ${CONTAINER} pb-12 pt-16`}>
          <div className="max-w-[640px]">
            <p className="text-[10px] tracking-[3px] text-white/55 uppercase mb-4">
              Limpieza profesional de sneakers · Villahermosa, Tabasco
            </p>
            {/* Título más pequeño que la versión anterior, sigue siendo mayor al subtítulo */}
            <h1
              className="text-white tracking-wide mb-4"
              style={{ fontFamily:"'Bebas Neue', sans-serif", fontSize:"clamp(36px, 4.8vw, 60px)", lineHeight: 1.02 }}
            >
              TUS TENIS FAVORITOS,<br />
              COMO RECIÉN SALIDOS<br />
              DE LA CAJA
            </h1>
            <div className="w-12 h-[3px] bg-white/40 rounded mb-4" />
            {/* Sin highlight azul — texto blanco simple */}
            <p className="text-white/85 text-[15px] leading-[1.7] mb-7 max-w-[480px]">
              Limpieza profesional especializada para todo tipo de sneakers.
              Trae tus tenis y recógelos impecables en 48 horas.
            </p>

            {/* Botón integrado dentro del hero, ya no es barra separada */}
            <div className="flex items-center gap-5 flex-wrap">
              <a
                href="#cta"
                onClick={() => track("ViewContent")}
                className="inline-flex items-center gap-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl px-7 py-3.5 text-[14px] font-black uppercase tracking-wide transition-colors whitespace-nowrap shadow-lg"
              >
      ...
      {/* ════════════════════════════════
          ② BRANDS — punto 6: más espacio, más ancho, mismo CONTAINER
      ════════════════════════════════ */}
      <section className="bg-white py-14 border-b border-gray-100">
        <div className={CONTAINER}>
          <p className="text-[11px] font-bold tracking-[3px] text-gray-400 uppercase text-center mb-9">
            Limpiamos el calzado que entrena contigo, día tras día
          </p>
          <div className="flex flex-wrap justify-center md:justify-between items-center gap-x-12 gap-y-5">
      ...
      {/* ════════════════════════════════
          ③ TESTIMONIOS
      ════════════════════════════════ */}
      <section id="testimonios" className="bg-gray-100 py-24">
        <div className={CONTAINER}>
          <Reveal>
      ...
      <section id="servicios" className="bg-white py-24">
        <div className={CONTAINER}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto mt-12 md:mt-20">
      ...
      {/* ════════════════════════════════
          ⑤ PROCESO
      ════════════════════════════════ */}
      <section id="proceso" className="bg-gray-100 pt-32 pb-24">
        <div className={CONTAINER}>
          <Reveal>
      ...
      {/* ════════════════════════════════
          ⑦ MEMBRESÍA
      ════════════════════════════════ */}
      <section id="membresia" className="bg-gray-100 pt-28 pb-24">
        <div className={CONTAINER}>
          ...
          <Reveal>
            <div className="bg-[#0d1526] rounded-2xl p-8 md:p-12">
      ...
      {/* ════════════════════════════════
          ⑧ CTA BANNER
      ════════════════════════════════ */}
      <section id="cta" className="relative flex items-center justify-center text-center overflow-hidden" style={{ minHeight:480 }}>
        ...
        <Reveal className={`relative z-10 w-full ${CONTAINER} py-24`}>
          <div className="max-w-2xl mx-auto">
            <h2 className="text-white tracking-wide mb-6"
              style={{ fontFamily:"'Bebas Neue', sans-serif", fontSize:"clamp(38px,5vw,64px)", lineHeight: 1.05 }}>
      ...
      {/* ════════════════════════════════
          ⑩ SUCURSALES
      ════════════════════════════════ */}
      <section id="sucursales" className="bg-gray-100 py-24">
        <div className={CONTAINER}>
          <Reveal>
